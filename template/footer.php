            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                <div class="footer__two-widget ml-85">
                    ...
                    <div class="footer__two-widget-solution">
                        <ul>
                            <li>
                                <a href="index.php"><i class="far fa-chevron-double-right"></i>Home</a>
                            </li>
                            <li>
                                <a href="about.php"><i class="far fa-chevron-double-right"></i>Who we are</a>
                            </li>
                            <li>
                                <a href="apply.php"><i class="far fa-chevron-double-right"></i>Apply for
                                    help</a>
                            </li>
                            <li>
                                <a href="blog.php"><i class="far fa-chevron-double-right"></i>News & blog</a>
                            </li>
                            <li>
                                <a href="contact.php"><i class="far fa-chevron-double-right"></i>Contact</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                <div class="footer__two-widget">
                    ...
                    <div class="footer__two-widget-solution">
                        <ul>
                            <li>
                                <a href="404.php"><i class="far fa-chevron-double-right"></i>Privacy</a>
                            </li>
                            <li>
                                <a href="404.php"><i class="far fa-chevron-double-right"></i>Terms and
                                    Condition</a>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="container">
            <div
                ...
                <div class="copyright__one-left text-center">
                    <p>© Resurtech 2024 | All Rights Reserved</p>
                </div>
            </div>
        </div>
    </div>
