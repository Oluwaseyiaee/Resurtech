            ...
            <div class="row">
                <div class="col-xl-7 col-md-7">
                    <div class="top__bar-left">
                        <a href="tel:(629)555-0129"><i class="fas fa-phone-alt"></i>+2348168143888</a>
                        <a href="mailto:resurtechglobal@gmail.com"><i class="fas fa-envelope"></i>resurtechglobal@gmail.com</a>
                    </div>
                </div>
                ...
                <div class="header__area-menubar-center">
                    <div class="header__area-menubar-center-menu menu-responsive">
                        <ul id="mobilemenu">
                            ...
                            <li class="menu-item-has-children">
                                <a href="apply.php">Apply for help </a>
                            </li>
                            <li class="menu-item-has-children">
                            ...
                            <div class="header__area-menubar-right-sidebar-popup-contact">
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <h6>
                                            <span class="text-white">resurtechglobal@gmail.com</span>
                                        </h6>
                                    </div>
                                </div>
                                <div
